//$ go run oopsla20-91/fgg -fgg -monomc=tmp/test/fg/monom/abcdef/mono-ok/i-closure.go -v fgg/examples/monom/abcdef/mono-ok/i-closure.go
//$ go run oopsla20-91/fgg -eval=-1 -v tmp/test/fg/monom/abcdef/mono-ok/i-closure.go
