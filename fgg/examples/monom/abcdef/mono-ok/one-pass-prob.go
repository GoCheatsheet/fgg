//$ go run oopsla20-91/fgg -fgg -monomc=tmp/test/fg/monom/abcdef/mono-ok/one-pass-prob.go fgg/examples/monom/abcdef/mono-ok/one-pass-prob.go
//$ go run oopsla20-91/fgg -eval=-1 -v tmp/test/fg/monom/abcdef/mono-ok/one-pass-prob.go
