//$ go run oopsla20-91/fgg -fgg -monomc=tmp/test/fg/monom/abcdef/mono-ok/i-closure-bad.go fgg/examples/monom/abcdef/mono-ok/i-closure-bad.go
//$ go run oopsla20-91/fgg -eval=-1 -v tmp/test/fg/monom/abcdef/mono-ok/i-closure-bad.go
