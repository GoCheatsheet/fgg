//$ go run oopsla20-91/fgg -fgg -monomc=tmp/test/fg/monom/abcdef/rcver-iface.go fgg/examples/monom/abcdef/rcver-iface.go
//$ go run oopsla20-91/fgg -eval=-1 -v tmp/test/fg/monom/abcdef/rcver-iface.go
