//$ go run oopsla20-91/fgg -fgg -monomc=tmp/test/fg/monom/abcdef/mono-ok/alternate.go fgg/examples/monom/abcdef/mono-ok/alternate.go
//$ go run oopsla20-91/fgg -eval=10 -v tmp/test/fg/monom/abcdef/mono-ok/alternate.go
