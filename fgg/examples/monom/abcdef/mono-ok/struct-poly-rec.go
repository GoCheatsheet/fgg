//$ go run oopsla20-91/fgg -fgg -monomc=tmp/fg/monom/abcdef/mono-ok/struct-prob.go -v fgg/examples/monom/abcdef/mono-ok/struct-poly-rec.go
//
//$ go run oopsla20-91/fgg -eval=-1 tmp/fg/monom/abcdef/mono-ok/struct-poly-rec.go
