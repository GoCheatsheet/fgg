//$ go run oopsla20-91/fgg -fgg -monomc=tmp/test/fg/monom/abcdef/mono-ok/meth-clash.go fgg/examples/monom/abcdef/mono-ok/meth-clash.go
//$ go run oopsla20-91/fgg -eval=7 -v tmp/test/fg/monom/abcdef/mono-ok/meth-clash.go
